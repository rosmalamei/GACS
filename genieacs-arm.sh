...
## CWMP
    ...
    << EOF> sudo systemctl edit --force --full genieacs-cwmp
[Unit]
...
## NBI
    ...
    << EOF> sudo systemctl edit --force --full genieacs-nbi
[Unit]
...
## FS
    ...
    << EOF> sudo systemctl edit --force --full genieacs-fs
[Unit]
...
## UI
    ...
    << EOF> sudo systemctl edit --force --full genieacs-ui
[Unit]
